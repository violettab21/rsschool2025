...
function createLightSchemeElement() {
  ...
  span.innerHTML = `<svg width="40px" height="40px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
...
function addLightSchemeElement() {
  document.querySelector(
    ".theme"
  ).innerHTML = `<svg width="40px" height="40px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
  <g id="Lager_93" data-name="Lager 93" transform="translate(2 2)">
    <g id="Sun_3_Brightness_3" data-name="Sun 3, Brightness 3">
      <path id="Path_68" data-name="Path 68" d="M32,14H27.033c-2,1.769-.779,4,.967,4h4.967C34.966,16.231,33.746,14,32,14Z" fill="#040505"/>
      <g id="Path_69" data-name="Path 69" fill="none" stroke-miterlimit="10">
...
function addDarkSchemeElement() {
  document.querySelector(
    ".theme"
  ).innerHTML = `<svg width="40px" height="40px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
function createSoundElement() {
  ...
  span.innerHTML = `<svg width="40px" height="40px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
function addSoundOffElement() {
  document.querySelector(
    ".sound"
  ).innerHTML = `<svg width="40px" height="40px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
