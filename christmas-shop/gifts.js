...
function createGiftsCards(gifts) {
  gifts.forEach((gift) => {
    generateGiftCardElement(gift);
  });
}

function generateGiftCardElement(gift) {
  let divGiftCard;
  ...
  let divGiftImage;
  divGiftImage = document.createElement("div");
  divGiftImage.className = "gift-card__image";
  let divGiftTest;
  divGiftTest = document.createElement("div");
  divGiftTest.className = "gift-card__text";
  let h4;
  ...
  document.querySelector(".gifts-background .gifts-cards").append(divGiftCard);
  divGiftCard.append(divGiftImage);
  divGiftCard.append(divGiftTest);
  divGiftTest.append(h4);
  divGiftTest.append(h3);
}
    ...
    if (event.target.closest(".gift-card")) {
      ...
      if (widthBeforeModal < widthAfterModal) {
        if (widthAfterModal <= 1440) {
          document.querySelector(".gifts-background").style.paddingRight =
            "17px";
...
function modalCloseButtonHandler() {
  document.querySelector(".icon-close").addEventListener("click", () => {
    ...
    document.body.style.overflow = "visible";
    document.querySelector(".gifts-background").style.paddingRight = 0;
